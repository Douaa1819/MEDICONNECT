    ...
    <img src="{{asset('images/logo.png')}}" alt="logo" width="190px" height="150px">
            ...
            <div class="flex items-center space-x-4">
                <ul class="font-medium flex flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                    <li>
                        <a href="/patient/profile" class="block py-2 px-4 text-white bg-blue-900 rounded md:bg-transparent md:text-blue-800 md:p-0 dark:text-white md:dark:text-blue-500" aria-current="page">Home</a>
                    </li>
