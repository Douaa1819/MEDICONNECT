        ...
        <aside class="bg-gradient-to-br from-gray-800 to-gray-900 -translate-x-80 fixed inset-0 z-50 h-[calc(100vh-32px)] w-72 rounded-xl transition-transform duration-300 xl:translate-x-0">
          <div class="relative border-b border-white/20">
            <a class="flex items-center gap-4 py-6 px-8" href="#/">
              <h6 class="block antialiased tracking-normal font-sans text-base font-semibold leading-relaxed text-white">Hello Doctor</h6>
            </a>
          ...
          <div class="m-4">
            <ul class="mb-4 flex flex-col gap-1">
              <li>
                <a aria-current="page" class="active" href="{{ route('doctor.doashbord') }}">
              ...
              <div class="flex items-center">
                ...
                <button aria-expanded="false" aria-haspopup="menu" id=":r2:" class="relative middle none font-sans font-medium text-center uppercase transition-all disabled:opacity-50 disabled:shadow-none disabled:pointer-events-none w-10 max-w-[40px] h-10 max-h-[40px] rounded-lg text-xs text-gray-500 hover:bg-blue-gray-500/10 active:bg-blue-gray-500/30" type="button">
                  <span class="absolute top-1/2 left-1/2 transform -translate-y-1/2 -translate-x-1/2">
                      ...
                      <i class="fa-solid fa-user" style="color: #86898d;"></i>
          ...
          <div class="col-span-12 mt-5">
              ...
              <ol class = "inline-flex items-center space-x-1 md:space-x-3">
                <li class = "inline-flex items-center">
                    <a href="{{ route('doctor.doashbord') }}" class = "inline-flex items-center text-sm font-medium text-gray-700 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white">                    
                        Today's calendrier
                    </a>
                </li>
                <li>
                    <div class = "flex items-center">
                        ...
                        <a href="{{route('Medicament.appointment')}}" class = "ml-1 text-sm font-medium text-gray-700 hover:text-gray-900 md:ml-2 dark:text-gray-400 dark:hover:text-white">appointement</a>
                    </div>
                </li>
            </ol>
        </nav>
              ...
              <div class="flex flex-col gap-5">
                ...
                <div class="flex items-center w-full justify-center  "> 
                  <form action="{{ route('consultation.form')}}" method="POST">
                    ...
                    <input type="hidden" name="patientID" value="{{ $appointment->patient->user->id }}">
                    <button class="flex items-center w-full justify-center  "> 
                        <div class="w-11/12">
                          <div for="appointment" class="inline-flex py-2 px-10 rounded-full items-center justify-between w-full text-gray-500 bg-white border border-green-500 cursor-pointer hover:text-gray-600 hover:bg-green-100 dark:text-gray-400 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700 peer-checked:border-blue-600 peer-checked:text-blue-600">    
                              <div class="text-lg font-semibold px-2">{{ $appointment->patient->user->name }}</div>
